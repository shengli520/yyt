...
class Start(myunit.MYtest):
    ...
    def test_01(self):
        ...
        homepage.click_gzjhgl()

        homepage.sleep(0.1)

        homepage.click_gzbggl()

        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://ehr.eascs.com/workreportMonthSearchPre.action?isReturn=NO']"))
    ...
    def test_02(self):
        ...
        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://ehr.eascs.com/assessPlanlineNewSearchPre.action?isReturn=NO']"))
