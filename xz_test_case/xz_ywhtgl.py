...
class Start(myunit.MYtest):
    ...
    def test1(self):
        ...
        homepage.click_ywhtgl()

        homepage.click_ywhtcx()

        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://oa2.eascs.com/eaoa/contractSearchPre.do']"))
    ...
    def test2(self):
        ...
        homepage.click_jydjcx2()

        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://oa2.eascs.com/eaoa/contractRequestSearchPre.do']"))
