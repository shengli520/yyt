...
class Start(myunit.MYtest):
    ...
    def test1(self):
        ...
        homepage.click_kwgl1()

        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://oa2.eascs.com/eaoa/seatSearchPre.do']"))
    ...
    def test2(self):
        ...
        homepage.click_kwbggl()

        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://oa2.eascs.com/eaoa/seatChangelineSearchPre.do']"))
    ...
    def test3(self):
        ...
        homepage.click_kwbglc()

        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://oa2.eascs.com/eaoa/seatChangeSearchPre.do']"))
    ...
    def test4(self):
        ...
        homepage.click_kwfyft()

        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://oa2.eascs.com/eaoa/seatFeeShareSearchPre.do']"))
