...
class Start(myunit.MYtest):
    ...
    def test1(self):
        ...
        homepage.click_hyscx()

        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://oa2.eascs.com/eaoa/meetingRoomSearchpre.do']"))
    ...
    def test2(self):
        ...
        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://oa2.eascs.com/eaoa/meetingSearchpre.do']"))
    ...
    def test3(self):
        ...
        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://oa2.eascs.com/eaoa/telephoneBillShareSearchpre.do']"))
