...
class Start(myunit.MYtest):
    ...
    def test1(self):
        ...
        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://oa2.eascs.com/eaoa/adConsumepurchaseSearchPre.do']"))
    ...
    def test2(self):
        ...
        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://oa2.eascs.com/eaoa/adConsumerequestSearchPre.do']"))
    ...
    def test3(self):
        ...
        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://oa2.eascs.com/eaoa/adConsumestockSearchPre.do']"))
    ...
    def test4(self):
        ...
        homepage.click_rkdcx()

        homepage.switch_frame(driver.find_element_by_xpath(
            "//iframe[@src='http://oa2.eascs.com/eaoa/adConsumeenterstockSearchPre.do']"))
