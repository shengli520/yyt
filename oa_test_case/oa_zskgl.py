...
class Start(myunit.MYtest):
	...
	def test1_zskgl(self):
		...
		homepage.click_zskgl()

		homepage.switch_frame(driver.find_element_by_xpath("//iframe[@src='http://oa2.eascs.com/eaoa/pubKnowledgeSearchPre.do']"))
