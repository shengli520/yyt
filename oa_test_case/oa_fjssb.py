...
class Start(myunit.MYtest):
	...
	def test_fhssb(self):
		...
		homepage.click_fjssb()


		homepage.switch_frame(driver.find_element_by_xpath("//iframe[@src='http://oa2.eascs.com/eaoa/addPayTaxSearchPre.do']"))
		...
		self.assertEqual(homepage.get_lrr(),"录入人")
