...
class Start(myunit.MYtest):
	...
	def test_zzssb(self):
		...
		homepage.click_zzssb()


		homepage.switch_frame(driver.find_element_by_xpath("//iframe[@src='http://oa2.eascs.com/eaoa/vatPayTaxSearchPre.do']"))
		...
		self.assertEqual(homepage.get_szlx(),"税种类型")
