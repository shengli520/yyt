...
class Start(myunit.MYtest):
	...
	def test1_oashym(self):
		...
		homepage.click_grgzt()

		homepage.sleep(0.1)

		homepage.click_oashym()

		homepage.switch_frame(driver.find_element_by_xpath("//iframe[@src='http://oa2.eascs.com/eaoa/cooperate.do']"))
