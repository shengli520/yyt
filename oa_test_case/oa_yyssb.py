...
class Start(myunit.MYtest):
	...
	def test_yyssb(self):
		...
		homepage.click_yyssb()


		homepage.switch_frame(driver.find_element_by_xpath("//iframe[@src='http://oa2.eascs.com/eaoa/butPayTaxSearchPre.do']"))
		...
		self.assertEqual(homepage.get_jnqrdj(),"缴纳确认单据")
